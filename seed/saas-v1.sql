-- DetailFlow SaaS Entitlement v1
-- Local seed only
...
INSERT OR IGNORE INTO plan_features (
  ...
  enabled, limit_value, unlimited,
  created_at, updated_at
) VALUES
(
  'pf_starter_users',
  'plan_starter', 'feature_users',
  1, 2, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_starter', 'feature_customers',
  1, 200, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_starter', 'feature_work_orders',
  1, 100, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
...
(
  ...
  'plan_starter', 'feature_inspection',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
...
(
  ...
  'plan_starter', 'feature_reports_basic',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_starter', 'feature_reports_advanced',
  0, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_starter', 'feature_custom_branding',
  0, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_starter', 'feature_multi_outlet',
  0, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
);
...
(
  ...
  'plan_pro', 'feature_reports_basic',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_pro', 'feature_reports_advanced',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_pro', 'feature_custom_branding',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
...
(
  ...
  'plan_business', 'feature_customers',
  1, NULL, 1,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_business', 'feature_work_orders',
  1, NULL, 1,
  unixepoch() * 1000,
  unixepoch() * 1000
),
...
(
  ...
  'plan_business', 'feature_inspection',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
...
(
  ...
  'plan_business', 'feature_payments',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_business', 'feature_reports_basic',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_business', 'feature_reports_advanced',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_business', 'feature_custom_branding',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
),
(
  ...
  'plan_business', 'feature_multi_outlet',
  1, NULL, 0,
  unixepoch() * 1000,
  unixepoch() * 1000
);